...
// Define Row Pins
#define ROWS  {GP28, GP27, GP26, GP18, GP9, GP29, GP8}
...
#define COLS { 0x0080, 0x0020, 0x0040, 0x0010, 0x0008, 0x0002, 0x0004}
...
#define OLED_FONT_H "keyboards/delikeeb/vananadiet/lib/glcdfont.c"
#endif